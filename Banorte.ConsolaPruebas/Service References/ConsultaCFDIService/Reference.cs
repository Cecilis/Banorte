...
namespace Banorte.ConsolaPruebas.ConsultaCFDIService {
    ...
    public interface IConsultaCFDIService {
        ...
        Banorte.ConsolaPruebas.ConsultaCFDIService.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<Banorte.ConsolaPruebas.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : Banorte.ConsolaPruebas.ConsultaCFDIService.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<Banorte.ConsolaPruebas.ConsultaCFDIService.IConsultaCFDIService>, Banorte.ConsolaPruebas.ConsultaCFDIService.IConsultaCFDIService {
        ...
        public Banorte.ConsolaPruebas.ConsultaCFDIService.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<Banorte.ConsolaPruebas.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa) {
