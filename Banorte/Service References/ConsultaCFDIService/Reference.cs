...
namespace Banorte.ConsultaCFDIService {
    ...
    public interface IConsultaCFDIService {
        ...
        Banorte.ConsultaCFDIService.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<Banorte.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : Banorte.ConsultaCFDIService.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<Banorte.ConsultaCFDIService.IConsultaCFDIService>, Banorte.ConsultaCFDIService.IConsultaCFDIService {
        ...
        public Banorte.ConsultaCFDIService.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<Banorte.ConsultaCFDIService.Acuse> ConsultaAsync(string expresionImpresa) {
